...
import { FolderGit2, CheckCircle2, Layers, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <section id="projects" className="py-16 md:py-24 bg-white border-b border-[#C9A227]/20">
          ...
          <div className="space-y-12">
            {sortedProjects.map((project, index) => {
              ...
              return (
                <div
                  key={project.id}
                  className="bg-[#FDFDF8] rounded-3xl p-6 sm:p-10 border border-[#C9A227]/30 shadow-lg hover:shadow-2xl transition-all duration-300 relative overflow-hidden"
                >
                  ...
                  <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 items-center ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                    ...
                    <div className={`lg:col-span-6 ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                      <div className="relative rounded-2xl overflow-hidden shadow-md border-2 border-white ring-gold">
                        <img
                          ...
                          <div className="flex items-center gap-3 overflow-x-auto pb-2">
                            {project.photo_gallery.map((photo, pIdx) => (
                              <button
                                ...
                                className="w-16 h-16 rounded-lg overflow-hidden border border-gray-200 hover:border-[#C9A227] flex-shrink-0 cursor-pointer transition-transform hover:scale-105"
                              >
                                <img
      ...
      {activePhoto && (
        ...
        >
          <div className="max-w-4xl max-h-[85vh] bg-white rounded-2xl p-2 overflow-hidden shadow-2xl relative">
            <img
