...
export default function LightboxModal({ event, onClose }: LightboxModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-fadeIn">
      ...
      <div className="relative w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#C9A227]/40 my-8 flex flex-col max-h-[90vh]">
                  ...
                  {paginatedPhotos.map((photoUrl, localIdx) => {
                    ...
                    return (
                      <button
                        ...
                        className="group relative aspect-square rounded-xl overflow-hidden bg-gray-100 border border-gray-200 hover:border-[#C9A227] shadow-sm hover:shadow-md transition-all cursor-pointer"
                      >
                        <img
      ...
      {activePhotoIndex !== null && (
        <div className="fixed inset-0 z-60 bg-black/95 flex items-center justify-center p-4">
          ...
          <button
            ...
            className="absolute top-6 right-6 p-3 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors cursor-pointer"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <button
            ...
            className="absolute left-4 sm:left-8 p-3 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="absolute right-4 sm:right-8 p-3 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors cursor-pointer"
          >
